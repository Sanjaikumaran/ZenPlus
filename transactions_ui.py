...
class transactionManagementApp:
    ...
    def __init__(self, master, window):
        ...
        self.master.bind("<Alt-n>", lambda event: self.add_new_transaction())
        self.master.bind("<Delete>", lambda event: self.remove_transaction())
        self.master.bind("<Alt-e>", lambda event: self.edit_transaction())
    ...
    def create_search_frame(self):
        ...
        self.add_button = Button(
            self.search_frame, text="Add New", command=self.add_new_transaction
        )
        self.edit_button = Button(
            self.search_frame, text="Edit ", command=self.edit_transaction
        )
        self.remove_button = Button(
            self.search_frame, text="Remove ", command=self.remove_transaction
        )
    ...
    def add_new_transaction(self, event=None):
    ...
    def save_new_transaction(self):
        ...
        transaction_data["TransactionID"] = str(transaction_id)
    ...
    def edit_transaction(self, event=None):
        ...
        if selected_item:
            ...
            for i, column in enumerate(self.columns):
                if column in ("SNo", "Transaction ID", "Timestamp"):
    ...
    def save_changes(self, selected_item):
        ...
        if self.sales_manager.update_transaction(transaction_id_value, modified_values):
            messagebox.showinfo("Success", "Transaction Updated")
        else:
            messagebox.showerror("Error", "Transaction Cannot be Updated")

    def remove_transaction(self, event=None):
        selected_items = self.tree.selection()
        ...
        if selected_items:
            ...
            if messagebox.askyesno("Confirm Removal", confirmation_message):
                ...
                for transaction_id in selected_transaction_ids:
                    self.sales_manager.remove_transaction(transaction_id)
